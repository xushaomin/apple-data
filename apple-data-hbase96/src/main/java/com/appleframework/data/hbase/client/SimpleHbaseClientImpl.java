...
public class SimpleHbaseClientImpl extends SimpleHbaseClientBase {
    ...
    //分页查询
    @Override
    public <T> Paginator<T> findPageAndKeyList(RowKey startRowKey, RowKey endRowKey, Class<? extends T> type,
	...
	private <T> Paginator<T> findPageAndKeyList_internal(RowKey startRowKey, RowKey endRowKey, Class<? extends T> type,
            @Nullable Filter filter, @Nullable QueryExtInfo queryExtInfo, 
            long pageNo, long pageSize) {
        Util.checkRowKey(startRowKey);
        Util.checkRowKey(endRowKey);
    ...
    @Override
    public <T> Paginator<T> findPageList(RowKey startRowKey, RowKey endRowKey, Class<? extends T> type, String id,
            @Nullable Map<String, Object> para, QueryExtInfo queryExtInfo,
            long pageNo, long pageSize) {
