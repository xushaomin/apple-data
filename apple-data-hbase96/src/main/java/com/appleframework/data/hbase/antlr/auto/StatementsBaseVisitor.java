...
public class StatementsBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements StatementsVisitor<T> {
	@Override public T visitTsexp(StatementsParser.TsexpContext ctx) { return visitChildren(ctx); }

	@Override public T visitRowkey_hbasestart(StatementsParser.Rowkey_hbasestartContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitSelectHqlCl(StatementsParser.SelectHqlClContext ctx) { return visitChildren(ctx); }

	@Override public T visitTsrange_start(StatementsParser.Tsrange_startContext ctx) { return visitChildren(ctx); }

	@Override public T visitRowkey_FuncConstant(StatementsParser.Rowkey_FuncConstantContext ctx) { return visitChildren(ctx); }

	@Override public T visitCidList(StatementsParser.CidListContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitMaxversionexp(StatementsParser.MaxversionexpContext ctx) { return visitChildren(ctx); }

	@Override public T visitRowkeyrange_start(StatementsParser.Rowkeyrange_startContext ctx) { return visitChildren(ctx); }

	@Override public T visitLimitexp(StatementsParser.LimitexpContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitRowkeyrange_startAndEnd(StatementsParser.Rowkeyrange_startAndEndContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitConstant2List(StatementsParser.Constant2ListContext ctx) { return visitChildren(ctx); }

	@Override public T visitTsrange_startAndEnd(StatementsParser.Tsrange_startAndEndContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitTablename(StatementsParser.TablenameContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitCidList_Regx(StatementsParser.CidList_RegxContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitFuncname(StatementsParser.FuncnameContext ctx) { return visitChildren(ctx); }
}