...
public class Config {
    ...
    public static Table getTable(String tableName) {
        return simpleHbaseClient.getHbaseDataSource().getTable(tableName);
    }

    public static void createTable() throws Exception {
        // create new table.
        HTableDescriptor tableDescriptor = new HTableDescriptor(TableNameUtil.getTableName(TableName));
    ...
    static {
        ...
        hbaseConfigResources.add(new CachedFileSystemResource(Config.HbaseSiteFile));
        hbaseConfigResources.add(new CachedFileSystemResource(Config.ZkConfigFile));
        ...
        hbaseTableConfig.setConfigResource(new CachedFileSystemResource(MyRecordXmlFile));
        ...
        simpleHbaseAdminClient = SimpleHbaseClientFactory.getWrapper(SimpleHbaseAdminClient.class, new SimpleHbaseAdminClientImpl());
        simpleHbaseAdminClient.setHbaseDataSource(simpleHbaseClient.getHbaseDataSource());
    }
}
