...
public class EncodingUtil {
     ...
     * @throws Exception 
     * */
    public static byte[] parseBytesFromHexString(String hexStr) throws Exception {
        StringBuilder sb = new StringBuilder();
    ...
    private static byte[] parseBytesFromHexString_0(String hexStr) throws Exception {
        if (hexStr.length() % 2 != 0) {
            throw new Exception("error. hexStr=" + hexStr);
        }
